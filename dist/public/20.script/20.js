...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] src/components/markdownEdit.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".markdown-edit .content {\n  overflow: hidden;\n  width: 100%;\n  position: relative;\n}\n.markdown-edit .content .edit {\n  float: left;\n  width: 50%;\n  height: 100%;\n}\n.markdown-edit .content .edit textarea {\n  height: 100%;\n}\n.markdown-edit .content .edit.active {\n  width: 100%;\n}\n.markdown-edit .content .edit .edit-tool {\n  position: absolute;\n  bottom: 0;\n}\n.markdown-edit .content .preview {\n  position: absolute;\n  top: 0;\n  right: 0;\n  box-sizing: border-box;\n}\n.markdown-edit .content .preview .btn-hide {\n  position: absolute;\n  top: 0;\n  right: 0;\n}\n.markdown-edit .content .preview .markdown-body,\n.markdown-edit .content .preview .btn-hide {\n  display: none;\n}\n.markdown-edit .content .preview.active {\n  width: 50%;\n  height: 100%;\n  padding: 0.625rem 0.9375rem;\n  border-left: 1px solid #ccc;\n}\n.markdown-edit .content .preview.active .markdown-body,\n.markdown-edit .content .preview.active .btn-hide {\n  display: block;\n}\n.markdown-edit .content .preview.active .btn-show {\n  display: none;\n}\n.markdown-edit .title {\n  border-bottom: 1px solid #ccc;\n}\n.markdown-edit .title input {\n  font-size: 28px;\n  padding: 0.875rem  1.313rem;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  methods: {
	    ...
	    save: function save() {
	      ...
	      if (this.md) {
	        _post2.default.update({ _id: this.md, content: markdown.content }).then(function (data) {});
	      } else {
	        _post2.default.markdown(this.markdown).then(function (data) {
	          // go markdown/:id页。。。。
	          // save thae data to share;
	          console.log(data);
	          _this.$router.go({ path: '/markdown/:id', params: { id: data._id } });
	        });
	      }
	    }
	  },
	  ...
	  data: function data() {
	    return {
	      markdown: this.share$.md ? (0, _assign2.default)({}, this.md) : {
	        content: ''
	      },
	      isPreview: false
	    };
	...
	//         <textarea class="ui" v-model="markdown.content" debounce="300"></textarea>
	//         <div class="edit-tool">
	//           <span class="ui">图片</span>
	//           <span class="ui" v-on:click="save">Po</span>
	//         </div>
	//       </div>
	//       <div class="preview" v-bind:class="{active:isPreview}">
