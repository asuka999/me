	...
	exports.default = {
	  ...
	  methods: {
	    ...
	    to: function to(direction) {
	      ...
	      if (this.index == direction) return;
	      var next = void 0,
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/components/photoList.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/less-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./photoList.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/less-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./photoList.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".post-item .title,\n.post-item .content {\n  margin-bottom: .25rem;\n}\n.post-item.markdown .content {\n  max-height: 30rem;\n}\n.post-item .post-item-footer {\n  font-size: .75em;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _marked = __webpack_require__(126);
	...
	//           <div v-for="photo of post.content" class="photo-item" v-on:click="isPreview[$index] = true" >
	//             <div class="photo-item-inner" v-bind:style="{'background-image' : 'url(' + photo + ')'}"></div>
	//           </div>
	//         </div>
	//         <div v-show="isPreview[$index]">
	//           <span class="ui" v-on:click="isPreview[$index] = false" >收起</span>
	...
	exports.default = {
	  ...
	  route: {
	    activate: function activate(transition) {
	      ...
	      _post2.default.query({ page: this.page, type: 'photo' }).then(function (data) {
	        _this.posts = data;
	        transition.next();
	      });
	    }
	  ...
	  filters: {
	    ...
	    title: function title(val) {
	      if (val.title) return val.title;else return 'po了新的' + (val.type == 'markdown' ? '文章' : '照片');
	    }
	  },
	  data: function data() {
	    return {
