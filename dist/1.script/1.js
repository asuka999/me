...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] web-app/components/home.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".home-head {\n  text-align: right;\n  padding: 0.625rem 0;\n  margin-bottom: 1.25rem;\n}\n.home-head h1.ui {\n  font-size: 5em;\n}\n.home-head p.ui {\n  font-size: 3em;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _postList = __webpack_require__(25);
	...
	// <template>
	//   <slider :imgs="share$.user && share$.user.imgs">
	//   </slider>
	//   <div class="module">
	//
	//     <div class="container">
	//       <div class="home-head" v-if="share$.user">
	//         <h1 class="ui" v-text="share$.user.profile1"></h1>
	//         <p class="ui" v-text="share$.user.profile2"></p>
	//       </div>
	//       <post-list
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] web-app/components/postList.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  activate: function activate(done) {
	    ...
	    _post2.default.query({ page: this.page }).then(function (data) {
	      _this.posts = data;
	      _this.isPreview = new Array(_this.posts.length);
	      done();
	    });
	  },
