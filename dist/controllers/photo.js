...
var _photo = require('../services/photo');
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            ...
                            return _context.abrupt('return', ctx.throw(400, 'missing url'));

                        case 3:
                            _context.next = 5;
                            return _photo2.default.create(md, ctx.session.user);
            ...
            return _regenerator2.default.wrap(function _callee2$(_context2) {
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        ...
                        case 6:
                            _context2.next = 8;
                            return _photo2.default.update({ _id: md }, md);
            ...
            return _regenerator2.default.wrap(function _callee3$(_context3) {
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        ...
                        case 3:
                            _context3.next = 5;
                            return _photo2.default.delete(md);
